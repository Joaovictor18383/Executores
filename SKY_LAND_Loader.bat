@echo off
title SKY LAND Loader
setlocal EnableExtensions

set "GITHUB_RAW_URL=https://raw.githubusercontent.com/Joaovictor18383/Executores/main/GITHUB_SCRIPT.txt"
set "TEMP_SCRIPT=%TEMP%\SKY_LAND_Latest_%RANDOM%.bat"
